class MON::Factured < MON::TransactionTable
	def load
		@name = "movimientos facturados"
		@title = Field.new("MOVIMIENTOS CON FACTURAS")
		@table_end = [Field.new("MOVIMIENTOS SIN FACTURAS"), Field.new("No se registran transacciones para el período")]
		@headers = []
