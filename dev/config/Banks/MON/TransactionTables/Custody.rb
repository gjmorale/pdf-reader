class MON::Custody < MON::TransactionTable
	def load
		@name = "movimientos en custodia"
		@title = Field.new("MOVIMIENTOS DE CUSTODIA")
		@table_end = [Field.new("MONEDA CORREDORES DE BOLSA"), Field.new("No se registran transacciones para el período")]
		@headers = []
