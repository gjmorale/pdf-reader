...
module FileReader
	...
	require File.dirname(__FILE__) + '/config/Banks/SIGA.rb'
	require File.dirname(__FILE__) + '/config/Banks/MBI.rb'
	require File.dirname(__FILE__) + '/config/Banks/Santander1.rb'
