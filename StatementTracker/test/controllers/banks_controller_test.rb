...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { code_name: @bank.code_name, folder_name: @bank.folder_name, name: @bank.name } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { code_name: @bank.code_name, folder_name: @bank.folder_name, name: @bank.name } }
