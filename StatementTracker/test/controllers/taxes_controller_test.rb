...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { bank_id: @tax.bank_id, periodicity: @tax.periodicity, quantity: @tax.quantity, society_id: @tax.society_id } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { bank_id: @tax.bank_id, periodicity: @tax.periodicity, quantity: @tax.quantity, society_id: @tax.society_id } }
