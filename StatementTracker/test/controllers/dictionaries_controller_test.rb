...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { identifier: @dictionary.identifier, target_id: @dictionary.target_id, target_type: @dictionary.target_type } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { identifier: @dictionary.identifier, target_id: @dictionary.target_id, target_type: @dictionary.target_type } }
