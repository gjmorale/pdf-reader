class BC1::InvestmentFundsMovCLP < BC1::TransactionTable
	def load
		@name = "movimientos de fondos de inversion en clp"
		@title = Field.new("Fondos de Inversión en Pesos Chilenos: Movimientos del Período")
		...
		@headers = []
			...
			headers << HeaderField.new("Monto Operación ($)", headers.size, Setup::Type::AMOUNT, false)
